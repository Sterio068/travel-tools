...
const NAV_ITEMS = [
  ...
  { href: "/topics", label: "主題", iconPath: "M4 6h16M4 12h16M4 18h10" },
];
...
export function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-[var(--color-surface-card)] border-t border-brand-200 shadow-[0_-2px_12px_rgba(8,51,68,0.06)]">
